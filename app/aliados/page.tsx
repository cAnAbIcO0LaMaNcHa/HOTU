  ...
  return (
    <section className="mx-auto max-w-3xl px-4 py-16 md:py-24">
      ...
      <p className="mt-8 font-mono text-sm leading-relaxed text-muted-foreground">
        HOTU trabaja con marcas, colectivos y espacios que quieren llegar a la comunidad
        electrónica de Bogotá y de las principales ciudades de Colombia. Si tu empresa
        quiere patrocinar un evento, activar en un Ritual Open Air, o simplemente
        conectar con esta escena, hablemos.
      </p>

      <div className="mt-10 grid gap-6 sm:grid-cols-3">
        <div className="border border-border bg-card p-5">
          <h3 className="font-bold">PATROCINIOS</h3>
          <p className="mt-2 font-mono text-xs text-muted-foreground">
            Presencia de marca en eventos HOTU, desde warehouse raves hasta open airs.
          </p>
        </div>
        <div className="border border-border bg-card p-5">
          <h3 className="font-bold">ACTIVACIONES</h3>
          <p className="mt-2 font-mono text-xs text-muted-foreground">
            Espacios de marca dentro de la experiencia del evento.
          </p>
        </div>
        <div className="border border-border bg-card p-5">
          <h3 className="font-bold">CONTENIDO</h3>
          <p className="mt-2 font-mono text-xs text-muted-foreground">
            Colaboraciones en discografía, sets y noticias del portal.
          </p>
        </div>
      </div>
      ...
      <div className="mt-14 border-t border-border pt-8">
        ...
        <p className="mt-3 font-mono text-sm text-muted-foreground">
          Escribinos contando de tu marca y qué te gustaría hacer con HOTU.
        </p>
        <a
