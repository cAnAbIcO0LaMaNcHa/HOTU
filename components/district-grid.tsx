  ...
  return (
    <section className="mx-auto max-w-7xl px-4 py-20">
      <span className="font-mono text-[10px] tracking-[0.3em] text-primary">
        / EL MAPA · 10 DISTRITOS
      </span>
      <h2 className="mt-4 text-4xl font-bold md:text-5xl">
        <span className="text-chrome">ENCUENTRA TU DISTRITO</span>
      </h2>
      <p className="mt-4 max-w-2xl font-mono text-sm text-muted-foreground">
        Cada distrito es una identidad sonora. Elige el tuyo y filtra eventos, artistas, sets y
        releases por el mood que compartes.
      </p>
      <div className="mt-10 grid gap-3 sm:grid-cols-2 lg:grid-cols-5">
        {DISTRICTS.map((d) => (
          ...
          >
            <span className="font-mono text-[10px] tracking-[0.3em] text-[var(--accent-base)]">
              {d.genre}
            </span>
